      ...
      <div className="flex gap-2">
        <div className="relative flex-1">
          ...
          <input
            ...
            className="w-full rounded-lg border border-border bg-surface py-2.5 pl-9 pr-8 text-sm text-foreground placeholder:text-muted focus:border-gold focus:outline-none"
          />
          {filters.search && (
            <button
      ...
      {showFilters && (
        <div className="flex gap-2 pt-1">
          <select
            ...
            className="flex-1 rounded-lg border border-border bg-surface px-2 py-2 text-xs text-foreground focus:border-gold focus:outline-none"
          >
            {PRICE_RANGES.map((r) => (
