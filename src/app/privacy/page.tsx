...
export const metadata: Metadata = {
  title: "Privacy Policy — BlowYourSavings",
  description: "Privacy policy for BlowYourSavings.com — how we handle your data.",
};
      ...
      <div className="mx-auto max-w-3xl px-4 py-12">
        ...
        <div className="space-y-6 text-sm leading-relaxed text-muted">
          ...
          <section>
            ...
            <p>
              BlowYourSavings.com (&quot;we&quot;, &quot;us&quot;, or &quot;our&quot;) collects minimal
          ...
          <section>
            ...
            <p>
              We use Google AdSense and may use other advertising networks that place cookies on
              your device. These cookies enable personalized advertising based on your browsing
              history. You can opt out of personalized advertising through{" "}
          ...
          <section>
            ...
            <ul className="mt-2 list-disc space-y-1 pl-5">
              ...
              <li>Various affiliate programs — product links</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              <a href="mailto:privacy@blowyoursavings.com" className="text-gold hover:underline">
                privacy@blowyoursavings.com
              </a>{" "}
