...
export const metadata: Metadata = {
  title: "Terms of Service — BlowYourSavings",
  description: "Terms of service for BlowYourSavings.com.",
};
      ...
      <div className="mx-auto max-w-3xl px-4 py-12">
        ...
        <div className="space-y-6 text-sm leading-relaxed text-muted">
          ...
          <section>
            ...
            <p>
              By accessing and using BlowYourSavings.com, you agree to these terms. If you do not
          ...
          <section>
            ...
            <p>
              BlowYourSavings provides curated product information and affiliate links for
          ...
          <section>
            ...
            <p>
              BlowYourSavings participates in affiliate programs. When you click links on our site
              and make purchases, we may earn commissions. This does not affect the price you pay.
              Our product selections are editorial and independent of affiliate relationships.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              BlowYourSavings is not affiliated with, endorsed by, or sponsored by any of the
          ...
          <section>
            ...
            <p>
              BlowYourSavings is provided &quot;as is&quot; without warranties of any kind. We are
