          ...
          <div>
            ...
            <div className="mt-6 flex flex-col gap-3 sm:mt-8">
              <a
                ...
                className="flex w-full items-center justify-center gap-2 rounded-xl bg-gold px-6 py-3.5 text-base font-bold text-background transition-colors hover:bg-gold-light sm:py-4 sm:text-lg"
              >
                Shop on Amazon
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer nofollow sponsored"
                className="flex w-full items-center justify-center gap-2 rounded-xl border border-gold/30 bg-surface px-6 py-3.5 text-base font-bold text-gold transition-colors hover:bg-gold/10 sm:py-4 sm:text-lg"
              >
                Shop on eBay
                <svg className="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" />
